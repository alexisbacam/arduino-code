...
// read battery level
 ...
 //   lb = lbt*1.0/100;
 lb=(16.5*promedio(100,analogRead(sensorPin))/1024);
...
int promedio(int numloop, int sensorPin){
	float aux= 0.0;
	for(int cont=1; cont <= numloop; cont ++){
		aux = aux + analogRead(sensorPin);
